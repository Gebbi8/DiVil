export function getStructeredData(xmlLines, comodi, v1, v2) {
  ...
  xmlLines.forEach((line) => {
    ...
    if (
      line.includes("triggeredBy=") ||
      line.includes("listOfRules[") ||
      line.includes("/notes[") ||
      line.includes("/listOfFunctionDefinitions[") ||
      line.includes("listOfUnitDefinitions[") ||
      line.includes("/sbml[1]/model[1]/listOfParameters[")
    )
      return;
    ...
    if (changeType != null && changeType != "move") {
      //second key old bzw newPath belegen
      ...
      if (line.includes("/annotation[")) {
        ...
        if (
          changes.includes(
            "<li id='" +
              id +
              "' class='list-group-item'>Annotations were changed,"
          )
        )
          return;
        ...
        changes +=
          "<li id='" +
          id +
          "' class='list-group-item'>Annotations were changed, which is not displayed here.</li>";
      ...
      } else if (line.includes("/listOfModifiers[1]"))
        path = path.substr(0, path.indexOf("/listOfModifiers[1]"));
      else if (line.includes("/listOfReactants[1]"))
        path = path.substr(0, path.indexOf("/listOfReactants[1]"));
      else if (line.includes("/listOfProducts[1]"))
        path = path.substr(0, path.indexOf("/listOfProducts[1]"));

      //console.log("org: ", path);
      if (changeType == "delete" && moveMap[path]) {
        path = moveMap[path];
      } //check weather the path was changed due to a move
      ...
      if (dataByKeys[path] == null) {
        ...
        // return;
        if (line.includes("/kineticLaw[1]")) {
          //path already handled -> math already added
...
function addChange(
  ...
  if (changeType == "update") {
    if (line.includes("/kineticLaw[")) {
      ...
      if (line.includes("/listOfParam")) {
        //update of local Parameter
        console.log(line);
        ...
        console.debug("hier1");
        let newParameter = newDoc
          .evaluate(newPath, newDoc, null, XPathResult.ANY_TYPE, null)
          .iterateNext();
        ...
        return (htmlChange +=
          "<li id='" +
          id +
          "' class='list-group-item'>Attribute <em><b><span class='" +
          changeClass +
          "'>" +
          changedAttr +
          "</span></b></em> of local parameter <b><em>" +
          newParameter.attributes.name.value +
          "</em></b> changed: " +
          oldVal +
          " &rarr; " +
          newVal);
    ...
    effectedNode = effectedNode.substring(
      effectedNode.lastIndexOf("/") + 1,
      effectedNode.lastIndexOf("[")
    );
    return (htmlChange +=
      "<li id='" +
      id +
      ...
      "</b></em> of <em><b>" +
      effectedNode +
      "</b></em> has changed: <span class='delete-color'>" +
      oldValue +
      "</span> &rarr;  <span class='insert-color'>" +
      newValue +
      "</span></li>");
  }
  ...
  if (changeType == "move") {
    ...
    alert(
      "A change (move) occured that is currently not handled by DiVil. Please contact tom.gebhardt@uni-rostock.de. At best you already attach you files to the mail."
    );
  ...
  if (elementType == "Attribute") {
    ...
    if (line.includes("/kineticLaw[")) {
      //change is in child node of kinetic law
      if (line.includes("/math[")) {
        alert(changeType + " on math attribute");
      } else if (
        line.includes("/parameter[") ||
        line.includes("/localParameter[")
      ) {
        // change on parameter attribute in kin. law //localParameter for SBML version 3
        //console.log(line);
        ...
        return (htmlChange +=
          "<li id='" +
          id +
          "' class='list-group-item'>Attribute <span class='" +
          changeClass +
          "'><em><b>" +
          name +
          "</b></em></span> of local paramter <em><b>" +
          parameterName +
          "</b></em> was " +
          changeFill +
          ": <span class='" +
        ...
        return (htmlChange +=
          ...
          "'>" +
          regEx(line, "name") +
          "</span></em></b> of kinetic law was " +
          changeFill +
          "</li>");
      }
    } else if (
      line.includes("listOfReactants[1]") ||
      line.includes("listOfProducts[1]") ||
      line.includes("listOfModifiers[1]")
    ) {
      elementName = regEx(line, "name");
      let val = regEx(line, value);
      let path = getLocalXPath(regEx(line, docPath));
      //console.log(path);
      let participant = doc.evaluate(
        path,
        doc,
        null,
        XPathResult.ANY_TYPE,
  ...
  if (elementType == "Node") {
    ...
    if (changeType == "insert") {
      ...
      if (line.includes("/reaction[")) {
        ...
        if (
          path.lastIndexOf("/*") - path.indexOf("[local-name()='reaction']") ==
          -2
        ) {
          ...
          htmlChange +=
            "<li id='" +
            id +
            "' class='list-group-item'><em><b><span class='insert-color'>Reaction</span></b></em> was added</li>";
          let newPath = regEx(line, "newPath");
          //htmlChange += "<li id='" + id + "' class='list-group-item'><em><b>Kinetic law</em></b>:</li>";
          ...
          htmlChange +=
            "<ul class='list-group'>" +
            getAllParticipant(newPath, newDoc, changeClass, id);
          ...
          if (math)
            htmlChange +=
              "<li id='" +
              id +
              "' class='list-group-item'><b><span class='insert-color'>Math</span></b>: " +
              math +
              "</li>";
          ...
          if (parameters)
            htmlChange +=
              "<li id='" +
              id +
              "' class='list-group-item'><b><span class='insert-color'>Parameters</span></b>: " +
              parameters +
              "</li>";
    ...
    if (
      val == "listOfReactants" &&
      dataByKeys[addPath].popup.includes("Reactants</span></b>:")
    )
      return "";
    if (
      val == "listOfProducts" &&
      dataByKeys[addPath].popup.includes("Products</span></b>:")
    )
      return "";
    if (
      val == "listOfParameters" &&
      dataByKeys[addPath].popup.includes("Parameters</span></b>:")
    )
      return "";
    if (
      val == "listOfLocalParameters" &&
      dataByKeys[addPath].popup.includes("Parameters</span></b>:")
    )
      return "";

    if (line.includes("/math[")) {
      if (dataByKeys[addPath].popup.includes("<math xmlns=")) {
        //math already added, e.g. modifier added
        console.log("multiple changes in one kinetic law");
        //alert("Error: Change in a kinetic law that was already")
        return "";
      } else {
        //hier changes inside kinetic law. no full delete or insert
        ...
        return (htmlChange +=
          "Math changed: <span class='delete-color'>" +
          oldMath +
          "</span> &rarr;  <span class='insert-color'>" +
          newMath +
          "</span>");
    ...
    if (val == "listOfModifiers") {
      //listOfModifiers changed
      console.debug(addPath);
      if (dataByKeys[addPath].popup.includes("Modifiers</span></b>:"))
        return ""; //for some reason bives sometimes has an untriggered change on modifiers although the whol reaction is added. BiVeS bug?
      return (htmlChange += getModifiers(
        regEx(line, docPath),
        doc,
        changeClass,
        changeFill,
    ...
    if (val == "modifierSpeciesReference") {
      //single modifier changed
      //console.log(line);
      return (htmlChange += getSingleModifier(
        regEx(line, docPath),
        doc,
        changeClass,
        changeFill,
    ...
    if (
      val == "kineticLaw" &&
      dataByKeys[addPath].popup.includes("Math</span></b>:")
    )
      return "";
    else {
    ...
    if (
      line.includes("speciesReference") ||
      line.includes("modifierSpeciesReference")
    ) {
      //single Participant added/deleted u
      ...
      if (node.hasAttribute("name"))
        participantName = node.attributes.name.value;
    ...
    if (
      line.includes("listOfReactants") ||
      line.includes("listOfProducts") ||
      line.includes("listOfModifiers")
    ) {
      let path = regEx(line, docPath);
      //console.log(path);
      ...
      return (
        "<li id='" +
        id +
        "' class='list-group-item'> List of  <span class='" +
        changeClass +
        "'><em><b>" +
        participantRole +
        "s</b></em></span> was " +
    ...
    return (htmlChange +=
      "<li id='" +
      id +
      "' class='list-group-item'><em><b><span class='" +
      changeClass +
      "'>" +
      oldValue[0].toUpperCase() +
      oldValue.substring(1) +
...
function getMath(path, doc) {
  ...
  console.debug("hier2");
  var mathML = doc
    .evaluate(path, doc, null, XPathResult.ANY_TYPE, null)
    .iterateNext();
...
function getParameters(path, doc, line, id) {
  if (line.includes("listOfLocalParameters"))
    path += "/kineticLaw[1]/listOfLocalParameters[1]/parameter";
  ...
  if (parameterlist != "")
    parameterlist =
      "<ul class='list-group list-group-horizontal'>" + parameterlist + "</ul>";
...
function getAllParticipant(path, doc, changeClass, changeFill, id) {
  ...
  participantsList +=
    "<li id='" +
    id +
    "' class='list-group-item'><span class='" +
    changeClass +
    "'><b>Reactants</span></b>: ";
...
function getModifiers(path, doc, changeClass, changeFill, id) {
  ...
  let modifiersList =
    ...
    "' class='list-group-item'><span class='" +
    changeClass +
    "'><em><b>List of modifiers</span></em></b> was " +
    changeFill +
    ":<ul class='list-group'>";
...
function getSingleModifier(path, doc, changeClass, changeFill, id) {
  ...
  return (
    "<li id='" +
    id +
    "' class='list-group-item'>Modifier <span class='" +
    changeClass +
    "'><em><b>" +
    speciesName +
    "</b></em></span> was " +
...
function getLocalXPath(path) {
  ...
  for (var j = 0; j < pathArray.length; j++) {
    ...
    } else if (splitArr[1] == null) {
      //last element not specified -> path to group
