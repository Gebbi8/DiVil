function sboSwitch(sboTerm){
	switch (sboTerm){
		...
		case "SBO:0000354": return "nucleicacidfeature" ; break; // informational molecule segment
		case "SBO:0000421": return "multimersimplechemical" ; break; // multimer of simple chemicals
		case "SBO:0000420": return "multimermacromolecule" ; break; // multimer of macromolecules
		case "SBO:0000419": return "multimernucleicacidfeature" ; break; // multimer of informational molecule segments
		case "SBO:0000253": return "complex" ; break; // non-covalent complex
		case "SBO:0000418": return "multimercomplex" ; break; // multimer of complexes
		case "SBO:0000285": return "unspecifiedentity" ; break; // material entity of unspecified nature
		case "SBO:0000291": return "source and sink" ; break; // empty set
		case "SBO:0000405": return "perturbingagent" ; break; // perturbing agent
		...
		case "SBO:0000397": return "omittedprocess" ; break; // omitted process
		case "SBO:0000396": return "uncertainprocess" ; break; // uncertain proces
		...
		case "SBO:0000173": return "andoperator" ; break; // and
		case "SBO:0000174": return "oroperator" ; break; // or
		case "SBO:0000238": return "notoperator" ; break; // not
		...
		case "SBO:0000171": return "necessarystimulation" ; break; // necessary stimulation
		case "SBO:0000398": return "logicarc" ; break; // logical relationship
		...
		case "SBO:0000461": return "necessarystimulation" ; break; // essential activator
		...
		case "SBO:0000534": return "necessarystimulation" ; break;
		case "SBO:0000535": return "necessarystimulation" ; break;
		case "SBO:0000536": return "inhibition" ; break;
		case "SBO:0000537": return "inhibition" ; break;
		case "SBO:0000533": return "necessarystimulation" ; break;
		...
		case "SBO:0000328": return "simplechemical" ; break;
		case "SBO:0000327": return "simplechemical" ; break;
